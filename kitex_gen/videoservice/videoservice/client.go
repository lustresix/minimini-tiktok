...
type Client interface {
	Feed(ctx context.Context, req *videoservice.FeedReq, callOptions ...callopt.Option) (r *videoservice.FeedResp, err error)
...
func (p *kVideoServiceClient) Feed(ctx context.Context, req *videoservice.FeedReq, callOptions ...callopt.Option) (r *videoservice.FeedResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Feed(ctx, req)
}

func (p *kVideoServiceClient) PublishAction(ctx context.Context, req *videoservice.PublishActionReq, callOptions ...callopt.Option) (r *videoservice.PublishActionResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.PublishAction(ctx, req)
}

func (p *kVideoServiceClient) CommentAction(ctx context.Context, req *videoservice.CommentActionReq, callOptions ...callopt.Option) (r *videoservice.CommentActionResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
