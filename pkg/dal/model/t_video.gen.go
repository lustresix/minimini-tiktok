...
type TVideo struct {
	ID            int64  `gorm:"column:id;type:int unsigned;primaryKey;autoIncrement:true" json:"id"`    // 视频id
	AuthorID      int64  `gorm:"column:author_id;type:int unsigned;not null" json:"author_id"`           // 作者id
	...
	FavoriteCount int64  `gorm:"column:favorite_count;type:int unsigned;not null" json:"favorite_count"` // 点赞数
	CommentCount  int64  `gorm:"column:comment_count;type:int unsigned;not null" json:"comment_count"`   // 评论数
