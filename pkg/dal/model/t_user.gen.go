...
type TUser struct {
	...
	UpdateDate    time.Time `gorm:"column:update_date;type:datetime;not null" json:"update_date"`           // 用户更新日期，格式为mm-dd
	DeleteDate    time.Time `gorm:"column:delete_date;type:datetime;not null" json:"delete_date"`           // 用户删除日期，格式为mm-dd
}
