...
func newTUser(db *gorm.DB, opts ...gen.DOOption) tUser {
	...
	_tUser.UpdateDate = field.NewTime(tableName, "update_date")
	_tUser.DeleteDate = field.NewTime(tableName, "delete_date")
...
type tUser struct {
	...
	UpdateDate    field.Time   // 用户更新日期，格式为mm-dd
	DeleteDate    field.Time   // 用户删除日期，格式为mm-dd
