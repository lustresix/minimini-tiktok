...
func newTComment(db *gorm.DB, opts ...gen.DOOption) tComment {
	...
	_tComment.UpdateDate = field.NewTime(tableName, "update_date")
	_tComment.DeleteDate = field.NewTime(tableName, "delete_date")
...
type tComment struct {
	...
	UpdateDate field.Time   // 评论更新日期，格式为mm-dd
	DeleteDate field.Time   // 评论删除日期，格式为mm-dd
...
func (t *tComment) updateTableName(table string) *tComment {
	...
	t.UpdateDate = field.NewTime(table, "update_date")
	t.DeleteDate = field.NewTime(table, "delete_date")
...
func (t *tComment) fillFieldMap() {
	...
	t.fieldMap["update_date"] = t.UpdateDate
	t.fieldMap["delete_date"] = t.DeleteDate
}
